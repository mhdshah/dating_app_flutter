...
class _MainProfileTwoScreenState extends State<MainProfileTwoScreen> {
          ...
          child: Stack(
            children: [
              PageView(
                ...
                children: [
                  pageMethod(context, ImageConstant.imgRectangle2089),
                  pageMethod(context, ImageConstant.imgRectangle2091),
                  pageMethod(context, ImageConstant.imgRectangle1600x340),
                  pageMethod(context, ImageConstant.imgRectangle1),
                  pageMethod(context, ImageConstant.imgRectangle2089)
                ],
              ),
              PageIndicator(
  ...
  Container pageMethod(BuildContext context, String imagePath) {
    return Container(
