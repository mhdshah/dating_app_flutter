...
class _MainProfileScreenState extends State<MainProfileScreen> {
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              /// Left click
              _showPageView ? Positioned(left:30, top: :0, child: cardTopTapWidget(TopTap.left)) : SizedBox(),

              /// Right click
              _showPageView ? cardTopTapWidget(TopTap.right) : SizedBox()
            ],
          ),
        ),
  ...
  Positioned cardTopTapWidget(TopTap topTap) {
    return Positioned(
      right: topTap == TopTap.right ? 30 : 0,
      left: topTap == TopTap.left ? 30 : 0,
      top: 0,
