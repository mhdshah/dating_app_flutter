          ...
          child: Stack(
            children: [
              PageView(
                ...
                children: [
                  MainCard(imagePath: ImageConstant.imgRectangle2089),
                  MainCard(imagePath: ImageConstant.imgRectangle2091),
                  MainCard(imagePath: ImageConstant.imgRectangle2091600x340),
                  MainCard(imagePath: ImageConstant.imgRectangle2091600x340),
                ],
              ),
              PageIndicator(
