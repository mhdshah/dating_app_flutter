...
class _MainProfileScreenState extends State<MainProfileScreen> {
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              /// Left click
              _showPageView ? cardTopTapWidget(TopTap.left) : SizedBox(),
  ...
  Positioned cardTopTapLeft(TopTap topTap) {
    return Positioned(
      right: 30,
      top: 0,
      child: GestureDetector(
        ...
        onTap: () {
          if (topTap == TopTap.right && _currentPageIndex != 0) {
  ...
  Positioned cardTopTapRight() {
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          if (_currentPageIndex != (_mainCardList.length - 1)) {
            _updateCurrentPageIndex(_currentPageIndex + 1);
          }
        },
      ),
