...
import 'package:dating_app/presentation/main_profile_screen/card_widget.dart';
import 'package:dating_app/presentation/main_profile_screen/page_indicator.dart';
...
class _MainProfileScreenState extends State<MainProfileScreen> {
            ...
            children: [
              ...
              _showPageView
                  ? Positioned(
                      left: 30,
                      top: 0,
                      child: cardTopTapWidget(TopTap.left),
                    )
                  : SizedBox(),
              ...
              _showPageView
                  ? Positioned(
                      right: 30,
                      top: 0,
                      child: cardTopTapWidget(TopTap.right),
                    )
                  : SizedBox()
            ],
          ),
  ...
  Widget cardTopTapWidget(TopTap topTap) {
    return GestureDetector(
      ...
      onTap: () {
        if (topTap == TopTap.left && _currentPageIndex != 0) {
          _updateCurrentPageIndex(--_currentPageIndex);
        } else if (topTap == TopTap.right &&
            _currentPageIndex != (_mainCardList.length - 1)) {
