...
import 'package:yuvi_s_application1/presentation/main_profile_one_page/main_profile_one_page.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    mainProfileThreeScreen: (context) => MainProfileThreeScreen(),
    noCardsScreen: (context) => NoCardsScreen(),
    appNavigationScreen: (context) => AppNavigationScreen(),
    initialRoute: (context) => MainProfileOnePage()
  };
}
